...
export const locationData: LocationCountry[] = [
  ...
  // Additional countries (65 more to reach 196 total)
  { name: 'Andorra', states: [{ name: 'Andorra la Vella', cities: [{ name: 'Andorra la Vella', latitude: 42.5063, longitude: 1.5218 }] }] },
  { name: 'Antigua and Barbuda', states: [{ name: 'Saint John', cities: [{ name: "Saint John's", latitude: 17.1274, longitude: -61.8468 }] }] },
  { name: 'Armenia', states: [{ name: 'Yerevan', cities: [{ name: 'Yerevan', latitude: 40.1872, longitude: 44.5152 }] }] },
  { name: 'Bahamas', states: [{ name: 'New Providence', cities: [{ name: 'Nassau', latitude: 25.0343, longitude: -77.3963 }] }] },
  { name: 'Barbados', states: [{ name: 'Saint Michael', cities: [{ name: 'Bridgetown', latitude: 13.1059, longitude: -59.6131 }] }] },
  { name: 'Belize', states: [{ name: 'Belize', cities: [{ name: 'Belmopan', latitude: 17.2510, longitude: -88.7590 }, { name: 'Belize City', latitude: 17.4984, longitude: -88.1886 }] }] },
  { name: 'Benin', states: [{ name: 'Littoral', cities: [{ name: 'Cotonou', latitude: 6.3654, longitude: 2.4183 }] }, { name: 'Ouémé', cities: [{ name: 'Porto-Novo', latitude: 6.4969, longitude: 2.6289 }] }] },
  { name: 'Bhutan', states: [{ name: 'Thimphu', cities: [{ name: 'Thimphu', latitude: 27.4728, longitude: 89.6393 }] }] },
  { name: 'Brunei', states: [{ name: 'Brunei-Muara', cities: [{ name: 'Bandar Seri Begawan', latitude: 4.9031, longitude: 114.9398 }] }] },
  { name: 'Burkina Faso', states: [{ name: 'Centre', cities: [{ name: 'Ouagadougou', latitude: 12.3714, longitude: -1.5197 }] }] },
  { name: 'Burundi', states: [{ name: 'Bujumbura Mairie', cities: [{ name: 'Bujumbura', latitude: -3.3731, longitude: 29.3644 }, { name: 'Gitega', latitude: -3.4264, longitude: 29.9246 }] }] },
  { name: 'Cape Verde', states: [{ name: 'Praia', cities: [{ name: 'Praia', latitude: 14.9315, longitude: -23.5125 }] }] },
  { name: 'Central African Republic', states: [{ name: 'Bangui', cities: [{ name: 'Bangui', latitude: 4.3947, longitude: 18.5582 }] }] },
  { name: 'Chad', states: [{ name: "N'Djamena", cities: [{ name: "N'Djamena", latitude: 12.1348, longitude: 15.0557 }] }] },
  { name: 'Comoros', states: [{ name: 'Grande Comore', cities: [{ name: 'Moroni', latitude: -11.7022, longitude: 43.2551 }] }] },
  { name: 'Congo', states: [{ name: 'Brazzaville', cities: [{ name: 'Brazzaville', latitude: -4.2634, longitude: 15.2429 }] }] },
  { name: 'Djibouti', states: [{ name: 'Djibouti', cities: [{ name: 'Djibouti', latitude: 11.5886, longitude: 43.1456 }] }] },
  { name: 'Dominica', states: [{ name: 'Saint George', cities: [{ name: 'Roseau', latitude: 15.3017, longitude: -61.3881 }] }] },
  { name: 'Equatorial Guinea', states: [{ name: 'Litoral', cities: [{ name: 'Malabo', latitude: 3.7523, longitude: 8.7741 }] }] },
  { name: 'Eritrea', states: [{ name: 'Maekel', cities: [{ name: 'Asmara', latitude: 15.3229, longitude: 38.9251 }] }] },
  { name: 'Eswatini', states: [{ name: 'Hhohho', cities: [{ name: 'Mbabane', latitude: -26.3054, longitude: 31.1367 }] }] },
  { name: 'Gabon', states: [{ name: 'Estuaire', cities: [{ name: 'Libreville', latitude: 0.4162, longitude: 9.4673 }] }] },
  { name: 'Gambia', states: [{ name: 'Banjul', cities: [{ name: 'Banjul', latitude: 13.4549, longitude: -16.5790 }] }] },
  { name: 'Grenada', states: [{ name: 'Saint George', cities: [{ name: "Saint George's", latitude: 12.0561, longitude: -61.7488 }] }] },
  { name: 'Guinea', states: [{ name: 'Conakry', cities: [{ name: 'Conakry', latitude: 9.6412, longitude: -13.5784 }] }] },
  { name: 'Guinea-Bissau', states: [{ name: 'Bissau', cities: [{ name: 'Bissau', latitude: 11.8636, longitude: -15.5977 }] }] },
  { name: 'Guyana', states: [{ name: 'Demerara-Mahaica', cities: [{ name: 'Georgetown', latitude: 6.8013, longitude: -58.1551 }] }] },
  { name: 'Ivory Coast', states: [{ name: 'Abidjan', cities: [{ name: 'Abidjan', latitude: 5.3600, longitude: -4.0083 }] }, { name: 'Yamoussoukro', cities: [{ name: 'Yamoussoukro', latitude: 6.8276, longitude: -5.2893 }] }] },
  { name: 'Kiribati', states: [{ name: 'Gilbert Islands', cities: [{ name: 'Tarawa', latitude: 1.3278, longitude: 172.9770 }] }] },
  { name: 'Kosovo', states: [{ name: 'Pristina', cities: [{ name: 'Pristina', latitude: 42.6629, longitude: 21.1655 }] }] },
  { name: 'Kyrgyzstan', states: [{ name: 'Bishkek', cities: [{ name: 'Bishkek', latitude: 42.8746, longitude: 74.5698 }] }] },
  { name: 'Lesotho', states: [{ name: 'Maseru', cities: [{ name: 'Maseru', latitude: -29.3151, longitude: 27.4869 }] }] },
  { name: 'Liberia', states: [{ name: 'Montserrado', cities: [{ name: 'Monrovia', latitude: 6.2907, longitude: -10.7605 }] }] },
  { name: 'Liechtenstein', states: [{ name: 'Vaduz', cities: [{ name: 'Vaduz', latitude: 47.1410, longitude: 9.5209 }] }] },
  { name: 'Malawi', states: [{ name: 'Central', cities: [{ name: 'Lilongwe', latitude: -13.9626, longitude: 33.7741 }] }] },
  { name: 'Mali', states: [{ name: 'Bamako', cities: [{ name: 'Bamako', latitude: 12.6392, longitude: -8.0029 }] }] },
  { name: 'Marshall Islands', states: [{ name: 'Majuro', cities: [{ name: 'Majuro', latitude: 7.0897, longitude: 171.3803 }] }] },
  { name: 'Mauritania', states: [{ name: 'Nouakchott', cities: [{ name: 'Nouakchott', latitude: 18.0735, longitude: -15.9582 }] }] },
  { name: 'Micronesia', states: [{ name: 'Pohnpei', cities: [{ name: 'Palikir', latitude: 6.9248, longitude: 158.1610 }] }] },
  { name: 'Monaco', states: [{ name: 'Monaco', cities: [{ name: 'Monaco', latitude: 43.7384, longitude: 7.4246 }] }] },
  { name: 'Nauru', states: [{ name: 'Yaren', cities: [{ name: 'Yaren', latitude: -0.5477, longitude: 166.9209 }] }] },
  { name: 'Niger', states: [{ name: 'Niamey', cities: [{ name: 'Niamey', latitude: 13.5117, longitude: 2.1251 }] }] },
  { name: 'North Korea', states: [{ name: 'Pyongyang', cities: [{ name: 'Pyongyang', latitude: 39.0392, longitude: 125.7625 }] }] },
  { name: 'Palau', states: [{ name: 'Melekeok', cities: [{ name: 'Ngerulmud', latitude: 7.5006, longitude: 134.6243 }] }] },
  { name: 'Palestine', states: [{ name: 'West Bank', cities: [{ name: 'Ramallah', latitude: 31.9038, longitude: 35.2034 }] }, { name: 'Gaza', cities: [{ name: 'Gaza City', latitude: 31.5, longitude: 34.4667 }] }] },
  { name: 'Papua New Guinea', states: [{ name: 'National Capital', cities: [{ name: 'Port Moresby', latitude: -9.4438, longitude: 147.1803 }] }] },
  { name: 'Saint Kitts and Nevis', states: [{ name: 'Saint George Basseterre', cities: [{ name: 'Basseterre', latitude: 17.3026, longitude: -62.7177 }] }] },
  { name: 'Saint Lucia', states: [{ name: 'Castries', cities: [{ name: 'Castries', latitude: 14.0101, longitude: -60.9875 }] }] },
  { name: 'Saint Vincent and the Grenadines', states: [{ name: 'Saint George', cities: [{ name: 'Kingstown', latitude: 13.1587, longitude: -61.2248 }] }] },
  { name: 'Samoa', states: [{ name: 'Tuamasaga', cities: [{ name: 'Apia', latitude: -13.8333, longitude: -171.7500 }] }] },
  { name: 'San Marino', states: [{ name: 'San Marino', cities: [{ name: 'San Marino', latitude: 43.9424, longitude: 12.4578 }] }] },
  { name: 'Sao Tome and Principe', states: [{ name: 'Água Grande', cities: [{ name: 'São Tomé', latitude: 0.3365, longitude: 6.7273 }] }] },
  { name: 'Seychelles', states: [{ name: 'Mahé', cities: [{ name: 'Victoria', latitude: -4.6191, longitude: 55.4513 }] }] },
  { name: 'Sierra Leone', states: [{ name: 'Western Area', cities: [{ name: 'Freetown', latitude: 8.4657, longitude: -13.2317 }] }] },
  { name: 'Solomon Islands', states: [{ name: 'Guadalcanal', cities: [{ name: 'Honiara', latitude: -9.4456, longitude: 159.9729 }] }] },
  { name: 'Somalia', states: [{ name: 'Banaadir', cities: [{ name: 'Mogadishu', latitude: 2.0469, longitude: 45.3182 }] }] },
  { name: 'South Sudan', states: [{ name: 'Central Equatoria', cities: [{ name: 'Juba', latitude: 4.8594, longitude: 31.5713 }] }] },
  { name: 'Suriname', states: [{ name: 'Paramaribo', cities: [{ name: 'Paramaribo', latitude: 5.8520, longitude: -55.2038 }] }] },
  { name: 'Tajikistan', states: [{ name: 'Dushanbe', cities: [{ name: 'Dushanbe', latitude: 38.5598, longitude: 68.7740 }] }] },
  { name: 'Timor-Leste', states: [{ name: 'Dili', cities: [{ name: 'Dili', latitude: -8.5569, longitude: 125.5603 }] }] },
  { name: 'Togo', states: [{ name: 'Maritime', cities: [{ name: 'Lomé', latitude: 6.1375, longitude: 1.2123 }] }] },
  { name: 'Tonga', states: [{ name: "Tongatapu", cities: [{ name: "Nuku'alofa", latitude: -21.1393, longitude: -175.2049 }] }] },
  { name: 'Turkmenistan', states: [{ name: 'Ahal', cities: [{ name: 'Ashgabat', latitude: 37.9601, longitude: 58.3261 }] }] },
  { name: 'Tuvalu', states: [{ name: 'Funafuti', cities: [{ name: 'Funafuti', latitude: -8.5211, longitude: 179.1962 }] }] },
  { name: 'Vanuatu', states: [{ name: 'Shefa', cities: [{ name: 'Port Vila', latitude: -17.7338, longitude: 168.3219 }] }] },
  { name: 'Vatican City', states: [{ name: 'Vatican City', cities: [{ name: 'Vatican City', latitude: 41.9029, longitude: 12.4534 }] }] }
];

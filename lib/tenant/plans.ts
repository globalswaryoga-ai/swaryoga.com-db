...
export const PLAN_DEFINITIONS: Record<PlanTier, PlanDefinition> = {
  ...
  [PlanTier.BASIC]: {
    tier: PlanTier.BASIC,
    name: 'Basic',
    description: 'Perfect for solo users getting started.',
    limits: {
      maxLeads: 1_000,
      maxUsers: 1,
    ...
    monthlyPriceINR: 499,
    annualPriceINR: 4_500,
  },

  [PlanTier.STARTER]: {
    tier: PlanTier.STARTER,
    name: 'Copper',
    description: 'For small teams — 3 users, 5K leads.',
    limits: {
      maxLeads: 5_000,
      maxUsers: 3,
    ...
    monthlyPriceINR: 999,
    annualPriceINR: 9_000,
  },

  [PlanTier.GROWTH]: {
    tier: PlanTier.GROWTH,
    name: 'Silver',
    description: 'Growing teams — 10 users, 15K leads.',
    limits: {
      maxLeads: 15_000,
      maxUsers: 10,
    ...
    annualPriceINR: 18_000,
  },

  [PlanTier.PROFESSIONAL]: {
    tier: PlanTier.PROFESSIONAL,
    name: 'Golden',
    description: 'Larger teams — 25 users, 50K leads.',
    limits: {
      maxLeads: 50_000,
      maxUsers: 25,
      maxWhatsAppTemplates: 9999,
    ...
    monthlyPriceINR: 2_999,
    annualPriceINR: 25_999,
  },

  [PlanTier.ENTERPRISE]: {
    tier: PlanTier.ENTERPRISE,
    name: 'Diamond',
    description: 'Enterprise — 50 users, unlimited leads.',
    limits: {
      maxLeads: 999_999,
      maxUsers: 50,
      maxWhatsAppTemplates: 9999,

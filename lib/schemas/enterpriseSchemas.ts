...
const KpBhavAnalysisSchema = new mongoose.Schema(
  {
    ...
    subLordAbcdPlanets: { type: String, trim: true, default: '' },
    subLordKaryeshBhav: { type: String, trim: true, default: '' },
    subLordRahuKetuConnection: { type: String, trim: true, default: '' },
    subLordDrishti: { type: String, trim: true, default: '' },
    subLordConjunction: { type: String, trim: true, default: '' },
    dashaChain: { type: String, trim: true, default: '' },
    toolkitMatter: { type: String, trim: true, default: '' },
    toolkitPrimaryHouse: { type: String, trim: true, default: '' },
    toolkitSupportingHouses: { type: String, trim: true, default: '' },
    toolkitOpposingHouses: { type: String, trim: true, default: '' },
    cslRetrogradeStatus: { type: String, trim: true, default: '' },
    cslStarLord: { type: String, trim: true, default: '' },
    cslStarLordOwner: { type: String, trim: true, default: '' },
    cslStarLordRetrogradeStatus: { type: String, trim: true, default: '' },
    cslStarLordSignification: { type: String, trim: true, default: '' },
    karyeshRuleResult: { type: String, trim: true, default: '' },
    karyeshRuleConclusion: { type: String, trim: true, default: '' },

...
// DO NOT use mongoose.model() at import time - it will fail with no connection!
...
// Export models using lazy evaluation
// These will work in both ESM imports and runtime calls

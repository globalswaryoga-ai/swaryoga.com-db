...
- [x] Restore Meta archive manifests into Bunny SQL: 2,646 manifest rows covering 1,165 phone conversations, so archived chats are discoverable in the inbox.

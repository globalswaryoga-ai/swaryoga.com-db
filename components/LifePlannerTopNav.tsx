    ...
    <header className="bg-white border-b border-swar-border shadow-sm sticky top-0 z-50">
      <div className="px-2 sm:px-6 py-2 sm:py-4 flex items-center justify-between gap-1.5 sm:gap-4">
        ...
        <div className="flex items-center gap-1 sm:gap-3 flex-shrink-0">
          ...
          <button
            onClick={() => router.back()}
            className="hidden sm:inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium bg-gray-100 hover:bg-gray-200 text-gray-700 transition-all duration-200 hover:scale-105 active:scale-95"
            title="Go Back"
          >

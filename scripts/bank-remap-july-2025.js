#!/usr/bin/env node
/**
 * Month-by-month workshop categorization — July 2025.
 * Applies the established 1:1 patterns from April-June:
 *  - ₹2,000 -> "Amrut Aahar (7 Days)"
 *  - ₹1,000 repeater entries -> "Swar Yoga L-1" (fixes mislabeled L-2/L-3/Weight Loss)
 *
 * Run: node scripts/bank-remap-july-2025.js
 */

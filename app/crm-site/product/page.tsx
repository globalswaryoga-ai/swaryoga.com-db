...
const FEATURE_SECTIONS = [
  ...
  },
  {
    id: 'qr-whatsapp',
    icon: Smartphone,
    title: 'QR WhatsApp (Anti-Ban)',
    desc: 'Send from your own QR-linked WhatsApp number with human-like pacing.',
    color: 'text-emerald-600 bg-emerald-50',
    bullets: [
      'Link any personal/business number via QR — no Meta approval needed',
      'Human-like random pacing (~15 msgs/hour) to protect from bans',
      'Smart 5 AM–10 PM window, daily caps & auto carry-over to next day',
      'Inbox, broadcasts, group merge, and scheduled sends',
      'Auto-skip blocked numbers + invisible message variation',
    ],
  },
  {
    id: 'voice',
  ...
  },
  {
    ...
    icon: Globe,
    title: 'Community',
    desc: 'Build an engaged member community with a social feed.',
    color: 'text-cyan-600 bg-cyan-50',
    bullets: [
      'Member feed with posts, likes, and comments',
      'Group discussions and announcements',
      'Member directory and profiles',
      'Moderation tools and role-based access',
      'Notifications to keep members coming back',
    ],
  },
  {
    id: 'elearning',
    icon: GraduationCap,
    title: 'E-Learning',
    desc: 'Sell and deliver courses with secure video streaming.',
    color: 'text-violet-600 bg-violet-50',
    bullets: [
      'Courses, lessons, and downloadable materials',
      'Secure HLS video player with anti-piracy controls',
      'Per-student enrollment, progress & device tracking',
      'Workshop/language-wise student management',
      'Analytics on watch time and completion',
    ],
  },
  {
    id: 'sadhana',
    icon: Sparkles,
    title: 'Sadhana Programs & Schedule',
    desc: 'Run spiritual programs with daily live sessions & tracking.',
    color: 'text-rose-600 bg-rose-50',
    bullets: [
      'Create multi-day sadhana programs with participants',
      'Daily live video sessions (Bunny CDN streaming)',
      'Attendance & join-history tracking per participant',
      'Daily schedule with reminders',
      'Progress dashboards for organizers',
    ],
  },
  {
    id: 'life-planner',
    icon: Calendar,
    title: 'Life Planner',
    desc: 'Personal goals, habits, and accounting in one place.',
    color: 'text-lime-600 bg-lime-50',
    bullets: [
      'Goal setting with action plans',
      'Daily habit and routine tracking',
      'Personal accounting — income & expenses',
      'Vision board and progress views',
      'Backup & restore of planner data',
    ],
  },
  {
    id: 'channels',
    ...
    desc: 'Reach leads across every channel from one inbox.',
    color: 'text-blue-600 bg-blue-50',
    bullets: [
      'Email campaigns with templates & scheduling',
      'SMS broadcasts to segmented lists',
      'Drip sequences and automations',
      'Open, click, and delivery tracking',
      'Per-plan monthly send limits',
    ],
  },
  {
    id: 'telegram',
    icon: Send,
    title: 'Telegram',
    desc: 'Broadcast and engage your audience on Telegram too.',
    color: 'text-sky-600 bg-sky-50',
    bullets: [
      'Connect a Telegram bot in minutes',
      'Broadcast to channels and groups',
      'Two-way messaging from the CRM inbox',
      'Media and link previews',
      'Unified contact timeline with WhatsApp',
    ],
  },
  {
    id: 'landing',
    icon: LayoutTemplate,
    title: 'Landing Pages',
    desc: 'Build lead-capture pages and forms — no developer needed.',
    color: 'text-fuchsia-600 bg-fuchsia-50',
    bullets: [
      'Drag-and-drop page builder',
      'Lead forms that drop straight into your funnel',
  ...
  },
  {
    ...
    desc: 'Sync invoices and payments with Tally accounting.',
    color: 'text-yellow-600 bg-yellow-50',
    bullets: [
      'Push invoices and receipts to Tally',
      'GST-ready billing records',
      'Per-tenant ledger mapping',

                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-lg font-mono text-gray-800 mt-2 break-all">{user.id}</p>
                    </div>
                  ...
                  <div className="mt-8 pt-8 border-t">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg border border-green-200">
                        <h5 className="font-bold text-green-900 mb-2">🏆 Member Rewards</h5>
                        <p className="text-green-800">Earn points with every purchase</p>
                      </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                  ...
                  {messages.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 text-sm mt-2">You'll see messages from the admin here</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      {messages.map((msg) => (
                        <div key={msg._id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition">
                          <div className="flex justify-between items-start mb-3">
                            <div>
                              <h5 className="font-bold text-gray-800">{msg.subject}</h5>
                              <p className="text-sm text-gray-500">From: {msg.senderName} ({msg.senderRole})</p>
                            </div>
                  ...
                  {showReplyForm && selectedMessage && (
                    <div className="mt-8 pt-8 border-t">
                      <h4 className="text-lg font-bold text-gray-800 mb-4">Reply to: {selectedMessage.subject}</h4>

...
const LifePlannerRitucharyaPage = dynamic(
  () => import('@/app/life-planner/dashboard/ritucharya/page'),
  {
    loading: () => (
...
export default function CrmRitucharyaPage() {
  ...
  return <LifePlannerRitucharyaPage />;
}

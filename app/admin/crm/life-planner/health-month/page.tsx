...
const LifePlannerHealthMonthPage = dynamic(
  () => import('@/app/life-planner/dashboard/health-month/page'),
  {
    loading: () => (
...
export default function CrmHealthMonthPage() {
  ...
  return <LifePlannerHealthMonthPage />;
}

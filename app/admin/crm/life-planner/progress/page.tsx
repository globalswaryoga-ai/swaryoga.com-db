...
const LifePlannerProgressPage = dynamic(
  () => import('@/app/life-planner/dashboard/progress/page'),
  {
    loading: () => (
...
export default function CrmProgressPage() {
  ...
  return <LifePlannerProgressPage />;
}

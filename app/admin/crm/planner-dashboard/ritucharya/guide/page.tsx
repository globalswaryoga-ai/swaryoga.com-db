...
const RASA_TAG_COLORS: Record<RasaKey, { bg: string; text: string; border: string }> = {
  madhura: { bg: 'bg-amber-50', text: 'text-amber-700', border: 'border-amber-200' },
  amla: { bg: 'bg-yellow-50', text: 'text-yellow-700', border: 'border-yellow-200' },
  lavana: { bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-200' },
  katu: { bg: 'bg-red-50', text: 'text-red-700', border: 'border-red-200' },
  tikta: { bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200' },
  kashaya: { bg: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-200' },
};

const RITU_CARD_COLORS: Record<RituKey, { gradient: string; border: string; badge: string }> = {
  grishma: { gradient: 'from-yellow-100 to-orange-100', border: 'border-yellow-200', badge: 'bg-yellow-100' },
  varsha: { gradient: 'from-blue-100 to-teal-100', border: 'border-blue-200', badge: 'bg-blue-100' },
  sharad: { gradient: 'from-orange-100 to-red-100', border: 'border-orange-200', badge: 'bg-orange-100' },
  hemant: { gradient: 'from-slate-100 to-cyan-100', border: 'border-slate-200', badge: 'bg-slate-100' },
  shishir: { gradient: 'from-cyan-100 to-blue-100', border: 'border-cyan-200', badge: 'bg-cyan-100' },
  vasant: { gradient: 'from-rose-100 to-pink-100', border: 'border-rose-200', badge: 'bg-rose-100' },
};

const KAAL_ICON: Record<string, React.ReactNode> = {
  brahma: '🌅', ushas: '🌤️', aditya: '☀️',
  aparahna: '🌞', pradosha: '🌅', nisha: '🌙',
};

export default function RitucharyaGuidePage() {

    ...
    <main className="min-h-screen pt-24 pb-16 bg-white">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex gap-2 mb-6 flex-wrap">
          <Link href="/admin/crm/planner-dashboard/ritucharya" className="px-4 py-2 rounded-lg text-sm font-medium bg-white text-gray-700 border hover:bg-gray-50">📝 Form</Link>
          ...
          <Link href="/admin/crm/planner-dashboard/ritucharya/calendar" className="px-4 py-2 rounded-lg text-sm font-medium bg-white text-gray-700 border hover:bg-gray-50">🗓️ Month Calendar</Link>
          <Link href="/admin/crm/planner-dashboard/ritucharya/recipes" className="px-4 py-2 rounded-lg text-sm font-medium bg-white text-gray-700 border hover:bg-gray-50">🍲 Recipes</Link>
        </div>
        {/* Header */}
        <div className="mb-8">

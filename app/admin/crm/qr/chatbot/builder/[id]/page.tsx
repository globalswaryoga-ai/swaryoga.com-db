...
export default function ChatbotBuilder() {
  ...
  useEffect(() => {
    ...
    const fetchDetail = async () => {
      ...
      try {
        setLoading(true);
        const res = await crm.fetch(`/api/admin/crm/qr/chatbot-flows/${chatbotId}`);
  ...
  const saveChatbot = useCallback(async () => {
    ...
    try {
      ...
      const endpoint = chatbotId === 'new' ? '/api/admin/crm/qr/chatbot-flows' : `/api/admin/crm/qr/chatbot-flows/${chatbotId}`;
    ...
    <div className="flex flex-col h-[100svh] bg-gray-50 overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <button 
            onClick={() => router.push('/admin/crm/qr/chatbot')}
        ...
        <div className="flex items-center gap-3">
          ...
          {chatbotId && chatbotId !== 'new' && (
            <button
              onClick={async () => {
                try {
                  const res = await crm.fetch(`/api/admin/crm/qr/chatbot-flows/${chatbotId}/duplicate`, { method: 'POST' });
                  if (res?._id) router.push(`/admin/crm/qr/chatbot/builder/${res._id}`);

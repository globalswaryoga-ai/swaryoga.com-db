            ...
            <div>
              ...
              <div className="relative">
                ...
                {showLanguageDropdown && (
                  <div className="absolute top-full left-0 right-0 mt-2 bg-black border border-gray-700 rounded-lg p-2 grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-64 overflow-y-auto z-10">

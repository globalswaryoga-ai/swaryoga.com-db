...
router.patch('/enrollment/:enrollmentId/read-all', async (req: Request, res: Response) => {
  try {
    const { enrollmentId } = req.params;
    
    const result = await ChatMessage.updateMany(
      { enrollmentId, isRead: false },
...
router.delete('/:id/reaction/:userId/:emoji', async (req: Request, res: Response) => {
  try {
...
router.get('/unread/:enrollmentId', async (req: Request, res: Response) => {
  try {
    const { enrollmentId } = req.params;
